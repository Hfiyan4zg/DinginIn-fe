...
function Headline() {
  return (
    <div className="flex flex-row bg-[#EEF6FF] max-md:flex-col max-md:gap-0 relative">
        <div className="flex flex-col">
          <section className="self-start mt-12 ml-44 text-[64px] font-bold text-black uppercase max-md:mt-10 max-md:max-w-full max-md:text-4xl">
          ...
          <section className="flex gap-0 self-start mt-9 ml-44 shadow-lg max-md:ml-2.5">
            <div className="justify-center px-8 py-6 text-base text-white uppercase bg-blue-600 max-md:px-5">Perbaiki Sekarang</div>
        ...
        <section className="flex gap-5 justify-between mt-20 w-full max-md:flex-wrap max-md:mt-10 max-md:max-w-full absolute bottom-0">
