...
function LearnMore() {
  return (
    <div>
        <section className="pb-10 w-full bg-blue-950 max-md:mt-10 max-md:max-w-full">
              ...
              <div className="max-md:mt-10 max-md:max-w-full">
                <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                  <div className="flex flex-col w-[76%] max-md:ml-0 max-md:w-full">
                    <div className="flex flex-col grow px-5 mt-24 max-md:mt-10 max-md:max-w-full">
                      <div className="text-6xl font-bold text-white uppercase max-md:max-w-full max-md:text-4xl leading-normal">
                        <span className="text-cyan-400 ">Dinginin</span> adalah <span className="text-yellow-400">Solusi</span> Kebutuhan AC Anda
                      </div>
                      <div className="mt-6 text-xl font-light leading-8 text-ellipsis text-slate-300 max-md:max-w-full">
                      Apakah AC Anda tidak bekerja dengan baik? Jangan khawatir! Di DinginIn, kami memiliki spesialisasi dalam layanan perbaikan AC terbaik yang mengembalikan kesejukan ke dalam ruangan Anda. Dengan tim teknisi kami yang terampil dan berpengalaman, kami berkomitmen untuk memberikan solusi yang cepat dan efektif untuk membuat Anda tetap nyaman sepanjang tahun.
                      </div>
